...
export default function AccountantDashboard() {
  ...
  const actions = (
    <div className="flex gap-4">
      ...
      <div className="h-12 px-6 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 flex items-center gap-4 shadow-xl">
                  ...
                  <tr key={bill.id} className="hover:bg-primary-50/30 transition-all group cursor-pointer" style={{ animationDelay: `${idx * 50}ms` }}>
                    ...
                    <td className="py-10 text-right">
                      <div className="flex flex-col items-end">
                        <p className="font-black text-gray-900 text-lg leading-none tracking-tight">PKR {(parseFloat(bill.total_amount) || 0).toLocaleString()}</p>
